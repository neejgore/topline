  ...
  try {
    ...
    const newArticles = [
      ...
      },
      {
        ...
        sourceUrl: 'https://digiday.com/media/connected-tv-ad-fraud-surges-340-percent-programmatic-scales/',
        sourceName: 'Digiday',
      ...
      },
      {
        ...
        sourceUrl: 'https://www.healthcaredive.com/news/healthcare-marketing-patient-journey-orchestration/567423/',
      ...
      },
      {
        ...
        sourceUrl: 'https://www.salesforceben.com/revenue-operations-teams-unified-customer-data-platforms/',
