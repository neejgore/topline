...
export async function POST() {
  try {
    console.log('🔄 Resetting content with expanded dataset...')
    ...
    // Insert expanded articles - 10 articles across verticals
    const articles = [
      {
        id: 'art1',
    ...
    // Insert expanded metrics - 5 metrics across verticals
    const metrics = [
      {
        id: 'met1',
    ...
    const response = {
      success: true,
      message: 'Content reset with expanded dataset!',
      results: {
