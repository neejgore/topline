  ...
  try {
    ...
    const metrics = [
      ...
      },
      {
        ...
        value: '28%',
        unit: 'Faster Close',
        context: 'B2B companies tracking pipeline velocity metrics see 28% faster deal closure compared to MQL-focused organizations.',
        source: 'B2B Sales Velocity Report 2024',
        sourceUrl: 'https://www.b2bsalesvelocity.com/report-2024/',
