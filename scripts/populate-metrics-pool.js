...
const metricsPool = [
  ...
  {
    title: "Mobile App Ad Spend",
    value: "362.2",
    unit: "billion USD",
    vertical: "Technology & Media",
    context: "Global mobile app advertising expenditure",
    source: "Mobile Marketing Report 2024"
  },
  {
    ...
    unit: "billion USD",
    vertical: "Technology & Media",
    context: "US podcast advertising revenue",
    source: "Podcast Advertising Report 2024"
  },
  ...
  },
  {
    ...
    unit: "x",
    vertical: "Consumer & Retail",
    context: "Return on investment for personalization efforts",
    source: "Personalization Impact Report 2024"
  },
  {
    title: "Omnichannel Retail Growth",
    value: "18.4%",
    unit: "percentage",
    vertical: "Consumer & Retail",
    context: "Growth in omnichannel retail strategies",
    source: "Omnichannel Retail Report 2024"
  },
  ...
  {
    title: "Fraud Detection AI Usage",
    value: "67%",
    unit: "percentage",
    vertical: "Financial Services",
    context: "Financial institutions using AI for fraud detection",
    source: "Financial AI Report 2024"
  },
  {
  ...
  {
    title: "RegTech Market Size",
    value: "12.3",
    unit: "billion USD",
    vertical: "Financial Services",
    context: "Regulatory technology market valuation",
    source: "RegTech Market Report 2024"
  },
  ...
  {
    title: "Digital Health Funding",
    value: "29.1",
    unit: "billion USD",
    vertical: "Healthcare & Life Sciences",
    context: "Global digital health funding volume",
    source: "Digital Health Report 2024"
  },
  {
    title: "Wearable Device Adoption",
    value: "35.8%",
    unit: "percentage",
    vertical: "Healthcare & Life Sciences",
    context: "Healthcare wearable device adoption rate",
    source: "Wearable Health Report 2024"
  },
  {
    ...
    unit: "billion USD",
    vertical: "Healthcare & Life Sciences",
    context: "Pharmaceutical digital marketing spending",
    source: "Pharma Marketing Report 2024"
  },
  ...
  },
  {
    ...
    unit: "million",
    vertical: "Energy & Utilities",
    context: "Global clean energy employment",
    source: "Clean Energy Jobs Report 2024"
  }
]

async function populateMetricsPool() {
  try {
    ...
    console.log(`🎉 Successfully populated metrics pool with ${metricsToInsert.length} metrics`)
