        ...
        <div class="section">
            ...
            <div class="metric-card">
                ...
                <div class="metric-columns">
                    ...
                    <div class="metric-column">
                        <h4>Sales Starters</h4>
                        <p style="font-weight: 600; color: #374151; margin-bottom: 8px; font-size: 13px;">Talk Track:</p>
                        ...
                        <a href="https://topline-tlwi.vercel.app/?expand=sales-intelligence" 
            ...
            <div class="article" style="border-left: 4px solid ${articleColors[index % articleColors.length]};">
                ...
                <div class="metric-columns" style="margin-top: 12px;">
                    <div class="metric-column">
                        ...
                        <a href="https://topline-tlwi.vercel.app/?expand=sales-intelligence" style="color: #2563eb; text-decoration: none; font-size: 12px; font-weight: 500;">See full insight →</a>
                    </div>
                    <div class="metric-column">
                        <h4>Sales Starters</h4>
                        <p style="font-weight: 600; color: #374151; margin-bottom: 6px; font-size: 13px;">Talk Track:</p>
