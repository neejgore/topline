...
function getStarRatingHTML(importanceScore) {
  ...
  return [0, 1, 2].map(i => 
    `<span style="color: ${i < starCount ? starColor : unfilledColor}; font-size: 14px;">★</span>`
  ).join('');
}
        ...
        <div class="section">
            ...
            <div class="article" style="border-left: 4px solid ${articleColors[index % articleColors.length]};">
                <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 8px;">
                    <span style="letter-spacing: -2px;">${getStarRatingHTML(article.importanceScore)}</span>
                    <span class="metric-tag">${article.vertical || 'General'}</span>
                </div>
                <h3 style="margin-top: 0;"><a href="https://belldesk.ai/" style="color: #111827; text-decoration: none; border-bottom: 1px solid #e5e7eb;">${decodeHtmlEntities(article.title || '')}</a></h3>
